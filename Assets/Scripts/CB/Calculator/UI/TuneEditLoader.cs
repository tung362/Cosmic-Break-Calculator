...
{
    /// <summary>
    /// UI loader for tunes editor
    /// </summary>
    public class TuneEditLoader : MonoBehaviour
    {
        public TuneBuilder Builder;
        [Header("Tune")]
        public TMP_InputField NameBind;
        public UIColorDropdown ColorBind;
        public UIMaskDropdown RequirementMaskBind;
        public TMP_InputField DiscriptionBind;
        public Toggle IsExBind;
